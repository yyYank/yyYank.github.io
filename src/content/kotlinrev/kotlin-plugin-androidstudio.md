---
title: "KotlinプラグインをAndroid Studioに入れる"
description: "逆引きKotlin: KotlinプラグインをAndroid Studioに入れる"
order: 3
---
...
[KotlinプラグインをIntelliJ IDEAに導入する](/kotlin-rev/kotlin-plugin-intellij/)と手順は同じです。
